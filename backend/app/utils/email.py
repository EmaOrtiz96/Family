...
MAIL_FROM = os.getenv("MAIL_FROM","FamilyPrint <noreply@familyprint.com>")
...
def email_bienvenida(to, nombre):
    send_email(to, "¡Bienvenido a FamilyPrint! 🌸", f"""
    <div style="font-family:Georgia,serif;max-width:500px;margin:auto;padding:2rem;">
      <h2 style="color:#1a1714;">¡Hola, {nombre}!</h2>
      <p>Gracias por unirte a <strong>FamilyPrint</strong>. Estamos felices de tenerte.</p>
...
def email_reset_password(to, nombre, token):
    ...
    send_email(to, "Restablecer contraseña — FamilyPrint", f"""
    <div style="font-family:Georgia,serif;max-width:500px;margin:auto;padding:2rem;">
