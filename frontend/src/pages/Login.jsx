    ...
    <div className={s.page}>
      <div className={s.deco}>
        <div className={s.decoInner}>
          ...
          <h2 className={s.decoTitle}>Bienvenido a<br/><em>FamilyPrint</em></h2>
        ...
        <div className={s.formBox}>
          ...
          {!forgot ? (
            <>
              ...
              <p className={s.sub}>{mode==='login'?'Ingresa tus datos para continuar':'Únete a la comunidad FamilyPrint'}</p>
